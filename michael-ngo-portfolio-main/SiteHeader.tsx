export default function SiteHeader({className=""}:{className?:string}){
  return <header className={`project-nav site-header ${className}`}>
    ...
    <nav aria-label="Primary navigation"><a href="/#work">Work</a><a href="/lessons">Bid Desk Lessons</a><a href="/about">About</a><a href="/resume">Career</a><a href="/credentials">Credentials</a><a href="/#contact">Contact</a></nav>
